...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-24 right-5 z-50 w-[90vw] max-w-sm h-[60vh] bg-white rounded-2xl border border-gray-200 shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto px-3 py-3 space-y-2 bg-gray-50">
            {messages.length === 0 && (
              <div className="text-center text-xs text-gray-400 py-8">Nadie ha escrito todavía. ¡Sé el primero!</div>
            )}
            {messages.map(m => {
          ...
          <div className="border-t border-gray-100 p-2 flex gap-2 shrink-0">
            <input
              ...
              className="flex-1 border border-gray-200 rounded-full px-4 py-2 text-sm focus:outline-none focus:border-purple-400"
            />
